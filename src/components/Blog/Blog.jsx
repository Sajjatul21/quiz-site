...
const Blog = () => {
    return (
        <div className="m-20">
            <div className="mb-10">
                <h1 className="text-2xl mb-8">What is the purpose of react-router?</h1>
                <p className="text-sm">
                    ...
                    <br></br> <br />
                    1. Client-side Routing: React Router allows you to define different routes in your application, associating each route with a specific React component. When the user navigates to a particular URL, React Router dynamically renders the corresponding React component on the page without a full page refresh. This provides a smoother user experience, as the page doesn't need to be reloaded for each route change.
                    <br /> <br />
                    2. Nested Routing: React Router supports nested routes, meaning you can have components that render within other components, each having their own set of routes. This allows for more granular control over the UI and better organization of components.
                    <br /> <br />
                    3. URL Manipulation: React Router provides tools for programmatically changing the URL without causing a full page reload. This is useful for scenarios like redirection after form submissions or controlling the URL based on user interactions.
                </p>
            </div>

            <div className="mb-10">
                <h1 className="text-2xl mb-8">How does context API work?</h1>
